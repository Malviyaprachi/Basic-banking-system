...
<body style="background-color:#212529;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <img src="statics/aag.jpg" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:white;">Owner of this Website</p>
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">AAYUSH GURJAR</h1>
            <p style="color:gray;"><b>Intern at Sparks Foundation <br> Shri Vaishnav Vidyapeeth Vishwavidyalaya, Indore</b></p>
    </center>
